    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setResponseMessage(errorData.message || "Failed to send your message.");
                setAlertType("error");
            }
        } catch (error) {
                ...
                <div className="-mx-4 flex flex-wrap lg:justify-between">
                    <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div className="mb-12 max-w-[570px] lg:mb-0 max-md:mx-4">
                            ...
                            <h2 className="mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px] text-gray-600">
                    ...
                    <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                        {responseMessage && (
                            <Alert
                                className="mb-4"
                                color={alertType === "success" ? "success" : "danger"} // Use "danger" for errors
                                title={alertType === "success" ? "Success" : "Error"} // Provide a title
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="mb-6">
                                    <input
                                        ...
                                        className="w-full rounded border px-[14px] py-3 text-base text-gray-600 outline-none focus:border-primary"
                                    />
                                </div>
                                <div className="mb-6">
                                    <input
                                ...
                                <div className="mb-6">
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full resize-none rounded border px-[14px] py-3 text-base text-gray-600 outline-none focus:border-primary"
                                    ></textarea>
                                </div>
                                <div>
